...
S_CASE tab[NB_LIGNE][NB_COLONNE]; // manipuler ce tableau avec les éléments situés dans Ressources.cpp

void Attente(int milli);
void setTab(int l,int c,int type=VIDE,pthread_t tid=0); // Pour modifier ligne et colonne en même temps ( si on rempli juste l et c ça fera une case vide par défaut)
